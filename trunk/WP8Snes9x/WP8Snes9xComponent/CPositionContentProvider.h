...
class CPositionDirect3DContentProvider : public Microsoft::WRL::RuntimeClass<
...
{
public:
	CPositionDirect3DContentProvider(PhoneDirect3DXamlAppComponent::CPositionDirect3DBackground^ controller);
...
private:
	PhoneDirect3DXamlAppComponent::CPositionDirect3DBackground^ m_controller;
